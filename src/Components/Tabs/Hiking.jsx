...
class Hiking extends React.Component {
	render() {
		return (
			<section id="hiking" className="section is-flex is-column">
				...
				<img
					...
					width="1024"
					src={"/horizon-hills/img/horsetooth-thin.webp"}
				/>
				<hr />
				<p>
				...
				<p>
					...
					(16.5 miles from Horizon Hills) in Loveland, Colorado is a moderate
					hike consisting of a 9.6 mile, out-and-back trail that rises about
					3,100/ft. The trail is rocky and dogs are permitted as long as they
					are on a leash. Completing this trail takes 6-8 hours on average.
